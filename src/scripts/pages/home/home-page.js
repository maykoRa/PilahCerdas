    ...
    return `
      <section class="first-section">
        ...
        <div class="ilustration>
          <img src="ilustrative-save-earth-outdoor.jpg" alt="Ilustrasi orang mengumpulkan sampah">
        </div>
      </section>
      ...
      <section class="second-section">
        ...
        <div>
          <div class="card-container">
            <img src="pile-of-rubbish.jpg"" alt="gambar tumpukan sampah">
          ...
          <div>
            <img src="PilahCerdas-tecnology.jpg" alt="tekonologi pilah cerdas">
          ...
          <div>
            <img src="three-trash-cans" alt="gambar tiga tempat sampah">
